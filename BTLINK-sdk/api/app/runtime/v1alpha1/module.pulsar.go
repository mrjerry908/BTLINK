// Code generated by protoc-gen-go-pulsar. DO NOT EDIT.
	...
	import (
	_ "btlinksdk.io/api/btlink/app/v1alpha1"
	fmt "fmt"
	...
	*x.list = (*x.list)[:n]
	...
	func init() {
	file_btlink_app_runtime_v1alpha1_module_proto_init()
	md_Module = File_btlink_app_runtime_v1alpha1_module_proto.Messages().ByName("Module")
	...
	mi := &file_btlink_app_runtime_v1alpha1_module_proto_msgTypes[0]
	...
	switch fd.FullName() {
	case "btlink.app.runtime.v1alpha1.Module.app_name":
	return x.AppName != ""
	case "btlink.app.runtime.v1alpha1.Module.begin_blockers":
	return len(x.BeginBlockers) != 0
	case "btlink.app.runtime.v1alpha1.Module.end_blockers":
	return len(x.EndBlockers) != 0
	case "btlink.app.runtime.v1alpha1.Module.init_genesis":
	return len(x.InitGenesis) != 0
	case "btlink.app.runtime.v1alpha1.Module.export_genesis":
	return len(x.ExportGenesis) != 0
	case "btlink.app.runtime.v1alpha1.Module.override_store_keys":
	return len(x.OverrideStoreKeys) != 0
	default:
	if fd.IsExtension() {
	panic(fmt.Errorf("proto3 declared messages do not support extensions: btlink.app.runtime.v1alpha1.Module"))
	}
	panic(fmt.Errorf("message btlink.app.runtime.v1alpha1.Module does not contain field %s", fd.FullName()))
	}
	}
	...
	panic(fmt.Errorf("message btlink.app.runtime.v1alpha1.Module does not contain field %s", descriptor.FullName()))
	}
	}
	...
	return protoreflect.ValueOfList(value)
	case "btlink.app.runtime.v1alpha1.Module.app_name":
	panic(fmt.Errorf("field app_name of message btlink.app.runtime.v1alpha1.Module is not mutable"))
	default:
	if fd.IsExtension() {
	panic(fmt.Errorf("proto3 declared messages do not support extensions: btlink.app.runtime.v1alpha1.Module"))
	}
	...
	switch d.FullName() {
	default:
	panic(fmt.Errorf("%s is not a oneof field in btlink.app.runtime.v1alpha1.Module", d.FullName()))
	}
	panic("unreachable")
	}
	...
	func init() {
	file_btlink_app_runtime_v1alpha1_module_proto_init()
	md_StoreKeyConfig = File_btlink_app_runtime_v1alpha1_module_proto.Messages().ByName("StoreKeyConfig")
	...
	mi := &file_btlink_app_runtime_v1alpha1_module_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	if ms.LoadMessageInfo() == nil {
	ms.StoreMessageInfo(mi)
	...
	switch fd.FullName() {
	case "btlink.app.runtime.v1alpha1.StoreKeyConfig.module_name":
	return x.ModuleName != ""
	case "btlink.app.runtime.v1alpha1.StoreKeyConfig.kv_store_key":
	return x.KvStoreKey != ""
	default:
	if fd.IsExtension() {
	panic(fmt.Errorf("proto3 declared messages do not support extensions: btlink.app.runtime.v1alpha1.StoreKeyConfig"))
	}
	panic(fmt.Errorf("message btlink.app.runtime.v1alpha1.StoreKeyConfig does not contain field %s", fd.FullName()))
	}
	}
	...
	panic(fmt.Errorf("message btlink.app.runtime.v1alpha1.StoreKeyConfig does not contain field %s", descriptor.FullName()))
	}
	}
	...
	switch fd.FullName() {
	case "btlink.app.runtime.v1alpha1.StoreKeyConfig.module_name":
	panic(fmt.Errorf("field module_name of message btlink.app.runtime.v1alpha1.StoreKeyConfig is not mutable"))
	case "btlink.app.runtime.v1alpha1.StoreKeyConfig.kv_store_key":
	panic(fmt.Errorf("field kv_store_key of message btlink.app.runtime.v1alpha1.StoreKeyConfig is not mutable"))
	default:
	if fd.IsExtension() {
	panic(fmt.Errorf("proto3 declared messages do not support extensions: btlink.app.runtime.v1alpha1.StoreKeyConfig"))
	}
	...
	switch d.FullName() {
	default:
	panic(fmt.Errorf("%s is not a oneof field in btlink.app.runtime.v1alpha1.StoreKeyConfig", d.FullName()))
	}
	panic("unreachable")
	}
	...
	// protoc (unknown)
	// source: btlink/app/runtime/v1alpha1/module.proto
	...
	*x = Module{}
	...
	return file_btlink_app_runtime_v1alpha1_module_proto_rawDescGZIP(), []int{0}
	}
	...
	*x = StoreKeyConfig{}
	...
	return file_btlink_app_runtime_v1alpha1_module_proto_rawDescGZIP(), []int{1}
	}
	...
	var File_btlink_app_runtime_v1alpha1_module_proto protoreflect.FileDescriptor
	
	var file_btlink_app_runtime_v1alpha1_module_proto_rawDesc = []byte{
	...
	var (
	file_btlink_app_runtime_v1alpha1_module_proto_rawDescOnce sync.Once
	file_btlink_app_runtime_v1alpha1_module_proto_rawDescData = file_btlink_app_runtime_v1alpha1_module_proto_rawDesc
	)
	
	func file_btlink_app_runtime_v1alpha1_module_proto_rawDescGZIP() []byte {
	file_btlink_app_runtime_v1alpha1_module_proto_rawDescOnce.Do(func() {
	file_btlink_app_runtime_v1alpha1_module_proto_rawDescData = protoimpl.X.CompressGZIP(file_btlink_app_runtime_v1alpha1_module_proto_rawDescData)
	})
	return file_btlink_app_runtime_v1alpha1_module_proto_rawDescData
	}
	
	var file_btlink_app_runtime_v1alpha1_module_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	var file_btlink_app_runtime_v1alpha1_module_proto_goTypes = []interface{}{
	(*Module)(nil), // 0: btlink.app.runtime.v1alpha1.Module
	(*StoreKeyConfig)(nil), // 1: btlink.app.runtime.v1alpha1.StoreKeyConfig
	}
	var file_btlink_app_runtime_v1alpha1_module_proto_depIdxs = []int32{
	1, // 0: btlink.app.runtime.v1alpha1.Module.override_store_keys:type_name -> btlink.app.runtime.v1alpha1.StoreKeyConfig
	...
	func init() { file_btlink_app_runtime_v1alpha1_module_proto_init() }
	func file_btlink_app_runtime_v1alpha1_module_proto_init() {
	if File_btlink_app_runtime_v1alpha1_module_proto != nil {
	return
	}
	if !protoimpl.UnsafeEnabled {
	file_btlink_app_runtime_v1alpha1_module_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	switch v := v.(*Module); i {
	case 0:
	return &v.state
	case 1:
	...
	file_btlink_app_runtime_v1alpha1_module_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	RawDescriptor: file_btlink_app_runtime_v1alpha1_module_proto_rawDesc,
	NumEnums: 0,
	NumMessages: 2,
	NumExtensions: 0,
	NumServices: 0,
	},
	GoTypes: file_btlink_app_runtime_v1alpha1_module_proto_goTypes,
	DependencyIndexes: file_btlink_app_runtime_v1alpha1_module_proto_depIdxs,
	MessageInfos: file_btlink_app_runtime_v1alpha1_module_proto_msgTypes,
	}.Build()
	File_btlink_app_runtime_v1alpha1_module_proto = out.File
	file_btlink_app_runtime_v1alpha1_module_proto_rawDesc = nil
	file_btlink_app_runtime_v1alpha1_module_proto_goTypes = nil
	file_btlink_app_runtime_v1alpha1_module_proto_depIdxs = nil
	}
