package appv1alpha1
	...
	import (
	fmt "fmt"
	runtime "github.com/btlink/btlink-proto/runtime"
	...
	*x.list = (*x.list)[:n]
	...
	func init() {
	file_btlink_app_v1alpha1_config_proto_init()
	md_Config = File_btlink_app_v1alpha1_config_proto.Messages().ByName("Config")
	...
	mi := &file_btlink_app_v1alpha1_config_proto_msgTypes[0]
	...
	switch fd.FullName() {
	case "btlink.app.v1alpha1.Config.modules":
	return len(x.Modules) != 0
	default:
	if fd.IsExtension() {
	panic(fmt.Errorf("proto3 declared messages do not support extensions: btlink.app.v1alpha1.Config"))
	}
	panic(fmt.Errorf("message btlink.app.v1alpha1.Config does not contain field %s", fd.FullName()))
	}
	}
	...
	panic(fmt.Errorf("message btlink.app.v1alpha1.Config does not contain field %s", descriptor.FullName()))
	}
	}
	...
	switch d.FullName() {
	default:
	panic(fmt.Errorf("%s is not a oneof field in btlink.app.v1alpha1.Config", d.FullName()))
	}
	panic("unreachable")
	}
	...
	func init() {
	file_btlink_app_v1alpha1_config_proto_init()
	md_ModuleConfig = File_btlink_app_v1alpha1_config_proto.Messages().ByName("ModuleConfig")
	...
	mi := &file_btlink_app_v1alpha1_config_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	if ms.LoadMessageInfo() == nil {
	ms.StoreMessageInfo(mi)
	...
	switch fd.FullName() {
	case "btlink.app.v1alpha1.ModuleConfig.name":
	return x.Name != ""
	case "btlink.app.v1alpha1.ModuleConfig.config":
	return x.Config != nil
	default:
	if fd.IsExtension() {
	panic(fmt.Errorf("proto3 declared messages do not support extensions: btlink.app.v1alpha1.ModuleConfig"))
	}
	panic(fmt.Errorf("message btlink.app.v1alpha1.ModuleConfig does not contain field %s", fd.FullName()))
	}
	}
	...
	panic(fmt.Errorf("message btlink.app.v1alpha1.ModuleConfig does not contain field %s", descriptor.FullName()))
	}
	}
	...
	case "btlink.app.v1alpha1.ModuleConfig.name":
	panic(fmt.Errorf("field name of message btlink.app.v1alpha1.ModuleConfig is not mutable"))
	default:
	if fd.IsExtension() {
	panic(fmt.Errorf("proto3 declared messages do not support extensions: btlink.app.v1alpha1.ModuleConfig"))
	}
	...
	switch d.FullName() {
	default:
	panic(fmt.Errorf("%s is not a oneof field in btlink.app.v1alpha1.ModuleConfig", d.FullName()))
	}
	panic("unreachable")
	}
	...
	// protoc (unknown)
	// source: btlink/app/v1alpha1/config.proto
	...
	// Config represents the configuration for a btlink SDK ABCI app.
	...
	*x = Config{}
	...
	return file_btlink_app_v1alpha1_config_proto_rawDescGZIP(), []int{0}
	}
	...
	//
	// For example, for the module btlink.bank.module.v1.Module, we may chose
	// to simply name the module "bank" in the app. When we upgrade to
	// btlink.bank.module.v2.Module, the app-specific name "bank" stays the same
	// and the framework knows that the v2 module should receive all the same state
	// that the v1 module had. Note: modules should provide info on which versions
	// they can migrate from in the ModuleDescriptor.can_migration_from field.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// config is the config object for the module. Module config messages should
	// define a ModuleDescriptor using the btlink.app.v1alpha1.is_module extension.
	...
	*x = ModuleConfig{}
	...
	return file_btlink_app_v1alpha1_config_proto_rawDescGZIP(), []int{1}
	}
	...
	var File_btlink_app_v1alpha1_config_proto protoreflect.FileDescriptor
	
	var file_btlink_app_v1alpha1_config_proto_rawDesc = []byte{
	...
	var (
	file_btlink_app_v1alpha1_config_proto_rawDescOnce sync.Once
	file_btlink_app_v1alpha1_config_proto_rawDescData = file_btlink_app_v1alpha1_config_proto_rawDesc
	)
	
	func file_btlink_app_v1alpha1_config_proto_rawDescGZIP() []byte {
	file_btlink_app_v1alpha1_config_proto_rawDescOnce.Do(func() {
	file_btlink_app_v1alpha1_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_btlink_app_v1alpha1_config_proto_rawDescData)
	})
	return file_btlink_app_v1alpha1_config_proto_rawDescData
	}
	
	var file_btlink_app_v1alpha1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	var file_btlink_app_v1alpha1_config_proto_goTypes = []interface{}{
	(*Config)(nil), // 0: btlink.app.v1alpha1.Config
	(*ModuleConfig)(nil), // 1: btlink.app.v1alpha1.ModuleConfig
	(*anypb.Any)(nil), // 2: google.protobuf.Any
	}
	var file_btlink_app_v1alpha1_config_proto_depIdxs = []int32{
	1, // 0: btlink.app.v1alpha1.Config.modules:type_name -> btlink.app.v1alpha1.ModuleConfig
	2, // 1: btlink.app.v1alpha1.ModuleConfig.config:type_name -> google.protobuf.Any
	...
	func init() { file_btlink_app_v1alpha1_config_proto_init() }
	func file_btlink_app_v1alpha1_config_proto_init() {
	if File_btlink_app_v1alpha1_config_proto != nil {
	return
	}
	if !protoimpl.UnsafeEnabled {
	file_btlink_app_v1alpha1_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	switch v := v.(*Config); i {
	case 0:
	return &v.state
	case 1:
	...
	file_btlink_app_v1alpha1_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	RawDescriptor: file_btlink_app_v1alpha1_config_proto_rawDesc,
	NumEnums: 0,
	NumMessages: 2,
	NumExtensions: 0,
	NumServices: 0,
	},
	GoTypes: file_btlink_app_v1alpha1_config_proto_goTypes,
	DependencyIndexes: file_btlink_app_v1alpha1_config_proto_depIdxs,
	MessageInfos: file_btlink_app_v1alpha1_config_proto_msgTypes,
	}.Build()
	File_btlink_app_v1alpha1_config_proto = out.File
	file_btlink_app_v1alpha1_config_proto_rawDesc = nil
	file_btlink_app_v1alpha1_config_proto_goTypes = nil
	file_btlink_app_v1alpha1_config_proto_depIdxs = nil
	}
