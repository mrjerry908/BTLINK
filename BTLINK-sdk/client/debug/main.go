package debug
	...
	"github.com/btlink/btlink-sdk/client"
	"github.com/btlink/btlink-sdk/crypto/keys/ed25519"
	"github.com/btlink/btlink-sdk/crypto/keys/secp256k1"
	cryptotypes "github.com/btlink/btlink-sdk/crypto/types"
	sdk "github.com/btlink/btlink-sdk/types"
	"github.com/btlink/btlink-sdk/types/errors"
	"github.com/btlink/btlink-sdk/version"
	
	legacybech32 "github.com/btlink/btlink-sdk/types/bech32/legacybech32" //nolint:staticcheck // we do old keys, they're keys after all.
	)
	...
	Example:
	$ %s debug pubkey '{"@type":"/btlink.crypto.secp256k1.PubKey","key":"AurroA7jvfPd1AadmmOvWM2rJSwipXfRf8yD6pLbA2DJ"}'
	`, version.AppName),
	...
	$ %s debug pubkey-raw btlink1e0jnq2sun3dzjh8p2xq95kk0expwmd7shwjpfg
	...
	Example:
	$ %s debug addr btlink1e0jnq2sun3dzjh8p2xq95kk0expwmd7shwjpfg
	`, version.AppName),
	Args: cobra.ExactArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
	addrString := args[0]
